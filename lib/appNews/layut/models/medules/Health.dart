...
class Health_Seccren extends StatelessWidget {
  const Health_Seccren({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NewsCubit, NewsStates>(
      ...
      builder: (context, states) {
        var c = NewsCubit.get(context).Health;
        print(c.length.toString());
        return states is LoedingHealthStates
            ? Center(
