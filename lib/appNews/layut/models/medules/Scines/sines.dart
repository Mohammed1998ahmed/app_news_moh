...
class Scines_Seccren extends StatelessWidget {
  const Scines_Seccren({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NewsCubit, NewsStates>(
      ...
      builder: (context, states) {
        var c = NewsCubit.get(context).Scinecs;
        print(c.length.toString());
        return states is LoedingScinecsStates
            ? Center(
