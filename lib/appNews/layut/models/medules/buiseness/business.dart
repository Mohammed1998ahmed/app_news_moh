...
class Business_Seccren extends StatelessWidget {
  const Business_Seccren({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NewsCubit, NewsStates>(
      ...
      builder: (context, states) {
        var c = NewsCubit.get(context).Businnes;
        print(c.length.toString());
        return states is LoedingBusinnesStates
            ? Center(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      ...
                      // WabViewPage(Uri: c[index]['url'].toString());
                    },
                    child: Padding(
